...
// ducalpha: extracted and ported command line class from Chromium
// Support OS_POSIX only (removed support for OS_WIN)
// Change base::StringPiece into StringType (i.e., std::string)
// Change base::StringPiece into StringType (i.e., std::string)
// Change FilePath to StringType
// Remove PrependWrapper (remove SplitString)
...
class BASE_EXPORT CommandLine {
 public:
  ...
  typedef std::map<StringType, const StringType*> StringPieceSwitchMap;
  ...
  // Switch names must be lowercase.
  std::string GetSwitchValueASCII(const StringType& switch_string) const;
  FilePath GetSwitchValuePath(const StringType& switch_string) const;
