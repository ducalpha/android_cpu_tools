...
#endif
// ducalpha: remove dependency on ThreadRestrictions
...
static int CallStat(const char *path, stat_wrapper_t *sb) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();
  return stat(path, sb);
}
...
bool RealPath(const FilePath& path, FilePath* real_path) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();  // For realpath().
...
int CreateAndOpenFdForTemporaryFile(FilePath directory, FilePath* path) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();  // For call to mkstemp().
...
bool CreateTemporaryFile(FilePath* path) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();  // For call to close().
  FilePath directory;
...
static bool CreateTemporaryDirInDirImpl(const FilePath& base_dir,
                                        ...
                                        FilePath* new_dir) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();  // For call to mkdtemp().
...
bool CreateDirectoryAndGetError(const FilePath& full_path,
                                File::Error* error) {
  // ducalpha: remove dependency on ThreadRestrictions//ThreadRestrictions::AssertIOAllowed();  // For call to mkdir().
